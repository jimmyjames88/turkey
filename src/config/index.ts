...
export const config = {
  ...
  get jwtIssuer() { return this.jwt.issuer; },
  get jwtAudience() { return this.jwt.audience; },
  get accessTokenTtl() { return this.jwt.accessTokenTtl; },
  get refreshTokenTtl() { return this.jwt.refreshTokenTtl; },
  get bcryptRounds() { return this.security.bcryptRounds; },
  get loginRateLimit() { return this.security.rateLimit.login; },
  get refreshRateLimit() { return this.security.rateLimit.refresh; },
  get keyRotationSchedule() { return this.keys.rotationSchedule; },
  get jwksCacheTtl() { return this.keys.jwksCacheTtl; },
  get logLevel() { return this.logging.level; },
};
